/* ============================================================
   EPM — inline SVG icon set. PORTED VERBATIM from the reference
   prototype's app/icons.js (Lucide-style, stroke=currentColor).
   Environment-proof: no icon-font ligatures.
   Do not hand-edit entries — re-extract from the reference if they change.
   ============================================================ */
