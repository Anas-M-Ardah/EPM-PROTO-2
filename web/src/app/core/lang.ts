...
const STR = {
  ...
  pal_run:          { ar: 'تشغيل أتمتة العرض',                 en: 'Run demo automation' },
  ...
  pal_engine_t:     { ar: 'تقييم القواعد متاح في وضع العرض',     en: 'Rule evaluation is available in demo mode' },
  pal_engine_b:     { ar: 'تُقيَّم الشروط القابلة للحساب عند فتح التنبيهات أو تشغيل أتمتة العرض. وتبقى مهلات المطالبة بالتمديد وقرار لجنتها بلا بيانات لحسابها.',
                      en: 'Computable conditions are evaluated when alerts open or demo automation runs. Extension-claim and committee-decision deadlines still lack data to calculate.' },
