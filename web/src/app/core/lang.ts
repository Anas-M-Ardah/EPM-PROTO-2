...
const STR = {
  ...
  prt_no_spend_t:  { ar: 'لا دفعات مسجَّلة',                 en: 'No payments recorded' },
  prt_no_spend_b:  { ar: 'يُبنى الصرف السنوي من تواريخ الدفعات المدفوعة فعلاً، لا من توزيع مقدَّر.',
                     en: 'Annual disbursement is built from the dates of payments actually paid, never from an estimated split.' },
  ...
  prt_no_milestones:{ ar: 'لا إنجاز مخطط بعد تاريخ البيانات.', en: 'No planned finish falls after the data date.' },
  prt_no_curve_t:  { ar: 'لا خط أساس ولا تحديثات إنجاز',    en: 'No baseline and no progress updates' },
  prt_no_curve_b:  { ar: 'يُرسَم المنحنى من خطوط أساس الأنشطة ومن تحديثات الإنجاز المسجّلة.',
                     en: 'The curve is drawn from activity baselines and recorded progress updates.' },
  prt_no_cost_curve_b:{ ar: 'يُرسَم المنحنى المالي من خطوط أساس الأنشطة ومن تواريخ الدفعات المدفوعة.',
                     en: 'The cost curve is drawn from activity baselines and the dates of payments actually paid.' },
  ...
  ovw_curve_empty_t: { ar: 'لا خط أساس ولا تحديثات إنجاز',  en: 'No baseline and no progress updates' },
  ovw_curve_empty_b: { ar: 'يُرسَم المنحنى من خطوط أساس الأنشطة ومن تحديثات الإنجاز المسجّلة في سجل نشاط العقد.',
                     en: 'The curve is drawn from the activity baselines and the progress updates recorded in the contract activity log.' },
