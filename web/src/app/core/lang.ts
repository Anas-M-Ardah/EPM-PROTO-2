...
const STR = {
  ...
  sup_kind_final:  { ar: 'استلام نهائي',                    en: 'Final receipt' },
  sup_log_final:   { ar: 'سجل الاستلام النهائي',            en: 'Final receipt log' },
  sup_new_final:   { ar: 'تسجيل استلام نهائي',              en: 'Record a final receipt' },
  sup_doc_final:   { ar: 'محضر استلام نهائي',               en: 'Final receipt record' },
  ...
  scd_roll_pct:       { ar: 'إنجاز العقد (تجميعي)',      en: 'Contract rollup' },
  ...
  prg_wbs_levels_sub:{ ar: 'الإنجاز المادي مرجّح بقيمة بنود الكميات المخصّصة؛ المخطط من موازنة الأنشطة',
                       en: 'Physical progress uses allocated BOQ value; planned progress uses activity budgets' },
  ...
  chg_not_applied: { ar: 'لم يُطبَّق بعد', en: 'Not applied yet' },
  chg_r_decision_summary: { ar: 'ملخص قرار الأمر التغييري', en: 'Change-order decision summary' },
  chg_r_next_action: { ar: 'الإجراء التالي المتاح', en: 'Next available action' },
  chg_r_apply_failed: { ar: 'توقف تطبيق الأمر', en: 'Order application stopped' },
  chg_r_apply_failed_note: { ar: 'راجع خطوة التطبيق التي فشلت أدناه، ثم أعد المحاولة بعد معالجة السبب.', en: 'Review the failed application step below, then retry after resolving its cause.' },
  ...
  chg_w_step_current: { ar: 'الخطوة الحالية', en: 'Current step' },
  chg_w_step_done: { ar: 'مكتملة', en: 'Complete' },
  chg_w_incomplete: { ar: 'أكمل الحقول التالية', en: 'Complete the following fields' },
  chg_w_missing_contract: { ar: 'اختر العقد.', en: 'Choose a contract.' },
  chg_w_missing_reason: { ar: 'أدخل مبرر الأمر.', en: 'Enter the order justification.' },
  chg_w_missing_party: { ar: 'اختر الجهة المسؤولة.', en: 'Choose the responsible party.' },
  chg_w_missing_number: { ar: 'أدخل رقم الكتاب الوارد.', en: 'Enter the incoming letter number.' },
  chg_w_missing_date: { ar: 'أدخل تاريخ الكتاب الوارد.', en: 'Enter the incoming letter date.' },
  chg_w_missing_effect: { ar: 'أضف بند كميات أو نشاطاً متأثراً واحداً على الأقل.', en: 'Add at least one affected BOQ line or activity.' },
  chg_w_preview_wait: { ar: 'بانتظار المعاينة المحسوبة من الخادم.', en: 'Waiting for the server-calculated preview.' },
  chg_w_preview_error: { ar: 'تعذرت معاينة الأثر', en: 'Impact preview failed' },
  chg_w_preview_title: { ar: 'معاينة الأثر قبل الإرسال', en: 'Impact preview before submission' },
  chg_w_preview_note: { ar: 'هذه قيم مقترحة يحسبها الخادم، وليست قيماً معتمدة أو مطبقة.', en: 'These are server-calculated proposals, not approved or applied values.' },
  chg_w_review_blocked: { ar: 'المعاينة الحالية لا تسمح بالإرسال. راجع الملاحظات وأعد المحاولة.', en: 'The current preview does not allow submission. Review the issues and retry.' },
  chg_w_analysis_pending: { ar: 'بانتظار تحليل الجدول', en: 'Awaiting schedule analysis' },
  chg_w_no_match: { ar: 'لا توجد نتائج تطابق البحث.', en: 'No results match this search.' },
  chg_w_clear_search: { ar: 'مسح البحث', en: 'Clear search' },
  chg_w_switch_confirm: { ar: 'سيؤدي تغيير العقد إلى إزالة البنود والأنشطة المحددة. هل تريد المتابعة؟', en: 'Changing the contract removes selected lines and activities. Continue?' },
  chg_w_cancel_confirm: { ar: 'ستفقد التغييرات غير المحفوظة. هل تريد الإلغاء؟', en: 'Unsaved changes will be lost. Cancel?' },
  ...
  chg_scope_t:     { ar: 'نطاق العرض',                      en: 'Viewing scope' },
  chg_scope_review_t: { ar: 'لا أوامر بانتظار إجرائك',       en: 'No orders await your action' },
  chg_scope_review_b: { ar: 'السجل متاح للمتابعة والاطلاع؛ لا يظهر إجراء قرار إلا للجهة المخوّلة في مرحلتها.',
                        en: 'The register remains available for review; a decision action appears only for the party authorised at its stage.' },
  chg_scope_delegate_b: { ar: 'تسجّل قرار الجهة الخارجية بصفة مُسجِّل؛ يبقى القرار منسوباً إلى الجهة.',
                            en: 'You record the external party’s decision; the decision remains attributed to that party.' },
  chg_forbidden_t: { ar: 'لا تملك صلاحية عرض أوامر التغيير لهذا المشروع',
                     en: 'You do not have permission to view this project’s change orders' },
  chg_forbidden_b: { ar: 'غيّر الشخصية المختارة إذا كانت لديك صفة مخوّلة، ثم أعد فتح السجل.',
                     en: 'Switch to an authorised persona, if available, then reopen the register.' },
  chg_open_record_hint: { ar: 'فتح سجل الأمر',               en: 'Open order record' },
  chg_effect_pending: { ar: 'معتمد ولم يُطبّق على العقد',    en: 'Approved, not applied to the contract' },
  ...
  chg_w_drop_hint: { ar: 'اسحب الملفات هنا أو اخترها من جهازك', en: 'Drop files here or choose them from your device' },
  ...
  chg_d_appr_err:  { ar: 'يجب إدخال القيمة المعتمدة من لجنة تثبيت الأسعار قبل اعتماد هذه المرحلة',
                     en: 'Complete the committee-approved figures, including a positive rate for excess quantities, before approving this stage.' },
  ...
  mdl_model_disciplines: { ar: 'تخصصات النموذج', en: 'Model disciplines' },
  mdl_model_groups: { ar: 'بنية النموذج', en: 'Model hierarchy' },
  mdl_source_aps: { ar: 'من بنية نموذج APS', en: 'From the APS model hierarchy' },
  mdl_elements_from_model: { ar: 'عناصر فعلية في النموذج', en: 'Actual model elements' },
  mdl_select_group_t: { ar: 'اختر مبنى من بنية النموذج', en: 'Select a building' },
  mdl_select_group_b: { ar: 'يعزل الاختيار العناصر الفعلية المرتبطة به داخل نموذج APS.', en: 'Selecting a hierarchy node isolates its actual APS model elements.' },
  mdl_linked_status: { ar: 'حالة العناصر المرتبطة', en: 'Linked element status' },
  mdl_metadata_loading: { ar: 'جارٍ قراءة بيانات النموذج…', en: 'Reading model metadata…' },
  mdl_metadata_unavailable: { ar: 'لا تتوفر شجرة بيانات لهذا الملف', en: 'No metadata tree is available for this file' },
  mdl_other: { ar: 'أخرى', en: 'Other' },
  ...
  mdl_tab_elements: { ar: 'العناصر المرتبطة', en: 'Linked elements' },
  mdl_element:      { ar: 'العنصر', en: 'Element' },
  mdl_location:     { ar: 'المبنى · الطابق', en: 'Building · level' },
  mdl_boq_line:     { ar: 'بند الكميات', en: 'BOQ line' },
  mdl_activity:     { ar: 'النشاط', en: 'Activity' },
  mdl_filter_empty: { ar: 'لا عناصر تطابق المرشّحات المختارة', en: 'No elements match the selected filters' },
  mdl_no_elements_t: { ar: 'لا عناصر مسجّلة لهذا المشروع', en: 'No elements are recorded for this project' },
  mdl_no_elements_b: { ar: 'تُسجَّل العناصر مع بند الكميات والنشاط اللذين تنتمي إليهما، ثم تظهر هنا بحالة تنفيذها.',
                       en: 'Elements are recorded with the BOQ line and activity they belong to, then appear here with their execution status.' },
  mdl_link_note_t:  { ar: 'العناصر سجلّ المشروع، والبنية من ملف النموذج', en: 'Elements are the project record; the hierarchy is the model file' },
  mdl_link_note_b:  { ar: 'يربط كل عنصر هنا ببند كميات ونشاط في عقده. لا يحمل العنصر بعدُ معرّف كائن في ملف النموذج، فاختياره لا يعزله في المشهد؛ استخدم بنية النموذج داخل العارض لذلك.',
                      en: 'Each element here links to a BOQ line and an activity in its contract. An element does not yet carry an object ID from the model file, so selecting one does not isolate it in the scene; use the model hierarchy inside the viewer for that.' },
  ...
  mdl_viewer_loading: { ar: 'جارٍ تحميل النموذج ثلاثي الأبعاد…', en: 'Loading the 3D model…' },
  mdl_viewer_error: { ar: 'تعذّر تحميل النموذج', en: 'Could not load the 3D model' },
  mdl_viewer_sdk_error: { ar: 'تعذّر تحميل مكوّن Autodesk Viewer', en: 'Autodesk Viewer failed to load' },
  mdl_viewer_unconfigured_t: { ar: 'لم يُربط ملف ثلاثي الأبعاد بهذا الإصدار', en: 'No 3D file is linked to this version' },
  mdl_viewer_unconfigured_b: { ar: 'أضف URN النموذج إلى إعدادات APS.', en: 'Add the model URN to the APS deployment settings.' },
  mdl_ver_t:        { ar: 'إصدارات النموذج',    en: 'Model versions' },
  mdl_ver_b:        { ar: 'يحمّل كل إصدار الملف المرتبط به، وتُقرأ البنية والأعداد من بيانات نموذج APS الفعلية.',
                      en: 'Each version loads its linked file, and its hierarchy and counts are read from the actual APS model data.' },
  mdl_empty_t:      { ar: 'لا نموذج مرفوع لهذا المشروع',    en: 'No model uploaded for this project' },
  mdl_empty_b:      { ar: 'اربط ملف نموذج بإصدار المشروع لعرضه وقراءة بنيته هنا.',
                      en: 'Link a model file to a project version to view it and read its hierarchy here.' },
  ...
  pal_run:          { ar: 'إعادة فحص الأتمتة',                 en: 'Re-run automation check' },
  pal_sla_notif_t:  { ar: 'تنبيه مهلة تدقيق',                  en: 'Audit SLA notification' },
  pal_sla_notif_sub:{ ar: 'يتطلب الإجراء الآن',                en: 'Action required now' },
  pal_sla_notif_body:{ ar: 'تجاوزت المعاملة سقف مهلة التدقيق. راجع مكتب التدقيق وأطلقها لحل سبب التنبيه.', en: 'This item exceeded its audit SLA. Review the holding desk and release it to resolve the alert cause.' },
  pal_sla_notif_item:{ ar: 'المعاملة',                         en: 'Item' },
  pal_sla_notif_later:{ ar: 'لاحقًا',                          en: 'Later' },
  pal_sla_notif_resolve:{ ar: 'مراجعة وحل المشكلة',            en: 'Review and resolve' },
  pal_run_done:     { ar: 'تمت محاكاة التسليمات · التصعيدات', en: 'Simulated deliveries · escalations:' },
  pal_escalated_to: { ar: 'صُعّد إلى',                       en: 'Escalated to' },
  pal_role_pm:      { ar: 'مدير المشروع',                    en: 'Project manager' },
  pal_role_dept:    { ar: 'مدير القسم',                      en: 'Department manager' },
  pal_role_tech:    { ar: 'الوكيل الفني',                    en: 'Technical deputy' },
  ...
  pal_engine_t:     { ar: 'فحص تلقائي لقواعد التنبيه',            en: 'Automatic alert-rule evaluation' },
  pal_engine_b:     { ar: 'تتحقق الخدمة تلقائيًا من الشروط القابلة للحساب كل دقيقة، وتقيسها بتاريخ بيانات المشروع. وتبقى مهلات المطالبة بالتمديد وقرار لجنتها بلا بيانات لحسابها.',
                      en: 'The service evaluates computable conditions automatically each minute against the project data date. Extension-claim and committee-decision deadlines still lack data to calculate.' },
  pal_demo_t:       { ar: 'سجل العرض للتسليم والتصعيد',          en: 'Demo delivery and escalation trail' },
  pal_demo_b:       { ar: 'تُحفظ محاولات التسليم المحاكية وسلسلة التصعيد؛ لا يُرسَل بريد أو رسالة فعلية. التسليمات · التصعيدات:',
                      en: 'Simulated deliveries and escalation steps are recorded; no real email or SMS is sent. Deliveries · escalations:' },
  ...
  doc_approve:     { ar: 'اعتماد المراجعة',                 en: 'Approve revision' },
  doc_reject:      { ar: 'رفض المراجعة',                    en: 'Reject revision' },
  doc_reject_reason:{ ar: 'سبب الرفض — مطلوب',              en: 'Reason for rejection — required' },
  doc_reject_confirm:{ ar: 'تأكيد الرفض',                   en: 'Confirm rejection' },
  doc_decided_approved:{ ar: 'اعتُمدت المراجعة R{no}',       en: 'Revision R{no} approved' },
  doc_decided_rejected:{ ar: 'رُفضت المراجعة R{no}',         en: 'Revision R{no} rejected' },
  doc_decision_note:{ ar: 'سبب القرار',                      en: 'Decision reason' },
