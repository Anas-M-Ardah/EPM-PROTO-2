...
| Guarded on the project's workspace | `EP-OVW-01` `EP-INF-01` `EP-PRJ-03/04` `EP-CON-01/02` `EP-BOQ-01`…`08` `EP-SCD-01/02` `EP-PRG-01/02` `EP-FIN-01` `EP-CHG-01` `EP-CHG-02` |
...
| `ChangeOrders` | Phase 5.1 | `EP-CHG-01` · `EP-CHG-02` — gained `AnalysisDays` (P-102) and the two preceding letters (P-103) in 5.2 |
| `ChangeOrderLines` | Phase 5.1 | `EP-CHG-02` — the four column sets الشكل 31 compares |
| `ChangeOrderActivities` | Phase 5.1 | `EP-CHG-02` — الشكل 32's affected activities |
| `ChangeOrderStages` | Phase 5.1 | `EP-CHG-01` · `EP-CHG-02` — BR-14 resolves the relation off this chain; names and owners come from `WorkflowMachine.Stages` (P-100) |
...
| `ChangeOrderAuditEntries` | Phase 5.2 | `EP-CHG-02` — one row per CHANGED FIELD, previous → new |
